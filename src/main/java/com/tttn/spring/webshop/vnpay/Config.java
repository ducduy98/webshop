 ...
 */
package com.tttn.spring.webshop.vnpay;
...
public class Config {
    ...
    public static String vnp_Returnurl = "http://localhost:8080/vnpay/success";
    public static String vnp_TmnCode = "XC0JFEDW";
    public static String vnp_HashSecret = "UCZIEAUEZGTXNNPLPMTZQMKJKFBMDQFL";
